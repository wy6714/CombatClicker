...
var captureBarRef: Node

@onready var player = get_node("/root/Main/Player")
@onready var playerMonsterList = get_node("/root/Main/Player/PlayerMonsterList")
var base_y

var enemyName: String
var enemyPassive: String
...
func move_to_button():
	...
	tween.tween_callback(Callable(self, "_on_reach_button"))
...
func _on_reach_button():
	if captureBarRef:
		playerMonsterList.captureMonster(enemyName, enemyPassive)
	queue_free()
